...
parser.add_argument('--experiment_name', dest='experiment_name', type=str, default='mymodel_con2_bdd_nouncertain',  help='name of experiment')
...
parser.add_argument('--use_uncertainty', dest='use_uncertainty', type=bool, default=False,help='max size of image pool, 0 means do not use image pool')
