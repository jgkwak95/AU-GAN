...
parser.add_argument('--experiment_name', dest='experiment_name', type=str, default='bdd_exp_2',  help='name of experiment')
...
parser.add_argument('--load_size', dest='load_size', type=int, default=572, help='scale images to this size')
...
parser.add_argument('--conf_lambda', dest='conf_lambda', type=float, default=1.0, help='weight on L1 term in objective')
...
parser.add_argument('--use_uncertainty', dest='use_uncertainty', type=bool, default=True, help='max size of image pool, 0 means do not use image pool')
